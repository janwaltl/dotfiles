...
kmap("n", "<leader>fk", ":FzfLua lines<CR>", { desc = "Search lines in open files" })
kmap("n", "<leader>fl", ":FzfLua loclist<CR>", { desc = "Search location list" })
...
kmap("v", "<leader>hs", ":GitGutterStageHunk<CR>", { desc = "Stage hunk" })
kmap("n", "<leader>hu", ":GitGutterUndoHunk<CR>", { desc = "Undu hunk" })
kmap("v", "<leader>hu", ":GitGutterUndoHunk<CR>", { desc = "Undu hunk" })
...
kmap("n", "gu", vim.lsp.buf.signature_help, { desc = "Show function signature" })
...
kmap("n", "ge", function() vim.diagnostic.open_float() end, {desc = "Open diagnostic"})
kmap("n", "[g", function() vim.diagnostic.jump({ count = -1 }) end, { desc = "Previous diagnostic" })
kmap("n", "]g", function() vim.diagnostic.jump({ count = 1 }) end, { desc = "Next diagnostic" })
...
kmap("v", "<leader>cf", vim.lsp.buf.format, { desc = "Format selection" })
